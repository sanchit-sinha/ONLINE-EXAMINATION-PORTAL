...
<body>
    ...
    <!-- onblur="generate_questions();generate_response_sheet();" -->
    <div id = "container">
        <div id = "create_tests">
                    ...
                    <form action="upload.php" method="post" enctype="multipart/form-data">
                        ...
                        <div id = "display_responses">
                            <h3>
                                ...
                                Name of Test : <input type="text" required name = "name_of_test" id = "name_of_test" >

                                <?php
                                    $str = document.getElementById('testname').value;
                                    echo $str;
                                ?>
                            </h3>
                        </div>
